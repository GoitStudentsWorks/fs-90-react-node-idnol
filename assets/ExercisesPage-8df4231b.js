import{b as c,q as ee,s as d,t as i,u as M,d as P,j as e,a as E,F as te,G as ie,H as re,D as L,J as Y,g as q,K as ne}from"./index-ff86338f.js";import{M as oe,a as se,W as ae,S as le,T as de,C as ce,b as pe,V as he,c as xe,d as ue,B as me,e as ge,f as fe,g as be,N as we,I as ke,h as je,i as ye,j as $,k as ve,l as Se,m as Ce,n as Ae}from"./AddExerciseSuccess.styled-15151172.js";import{a as Z}from"./ReusableStyles.styled-85d46c75.js";function Be(t){const[r,n]=c.useState([]);return c.useEffect(()=>{(async()=>{try{const s=await ee.get(`/exercises/filters?filter=${t}`);n(s.data)}catch(s){console.error("Error fetching categories:",s)}})()},[t]),r}const Ee=d.div`
position: relative;
`,Fe=d.div`
  max-width: 335px;
  margin-right: auto;
